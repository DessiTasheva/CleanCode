...
namespace BattleShips.GameLogic
{
    public class Engine:IEngine
    {
        ...
        {
            if (this.hiddenGrid.GetCellByPosition(this.shotPosition) != GlobalConstants.BlankSymbol)
            {
                this.ProcessShipHit();
                this.visibleGrid.SetCellByPosition(this.shotPosition, GlobalConstants.HitSymbol);
            }
            else
            {
                this.visibleGrid.SetCellByPosition(this.shotPosition, GlobalConstants.MissSymbol);
        ...
        private void ProcessShipHit()
        {
            for (int i = 0; i < this.Ships.Count; i++)
            {
                ...
                if (this.IsShipHit(currentShip, this.shotPosition) && this.visibleGrid.GetCellByPosition(this.shotPosition) != GlobalConstants.HitSymbol)
                {
        ...
        {
            var row = ship.TopLeftPosition.Row;
            var col = ship.TopLeftPosition.Col;
